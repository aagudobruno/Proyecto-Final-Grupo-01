...
def print_explosion_tocado():
    print ("""
    Bien, has tocado un barco
       ________________
         _ ._  _ , _ ._
        (_ ' ( `  )_  .__)
      ( (  (    )   `)  ) _)
...
def print_explosion_hundido():
    print ("""
                     Bien, has hundido un barco
       ________________
                          ____/ (  (    )   )  \___
                         /( (  (  )   _    ))  )   )\
                       ((     (   )(    )  )   (   )  )
...
( ___ )------------------------------------( ___ )
 | / |                                      | \ |
 | / |    El ganador es el jugador 2,NICE   | \ |
 |___|                                      |___|
(_____)------------------------------------(_____)
...
( ___ )------------------------------------( ___ )
 | / |                                      | \ |
 | / |    El ganador es el jugador 1,NICE   | \ |
 |___|                                      |___|
(_____)------------------------------------(_____)
